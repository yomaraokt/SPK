  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">SPK Jurusan SMA</a>
        </div>
    ...
    ?>
      ...
      <div class="col-lg-12 col-lg-offset-0 centered">
        ...
        <b>1. Daftar sebagai Peserta </b>: Dosen mendaftarkan diri dalam pemilihan Jurusan SMA dan tidak dapat melakukan penilaian terhadap dosen lain. <br>
        <b>2. Lakukan Penilaian </b> : Dosen melakukan penilaian terhadap dosen-dosen sejawat yang terdaftar sebagai peserta pemilihan Jurusan SMA tetapi tidak dapat mendaftar sebagi peserta. <br>
        <br>
