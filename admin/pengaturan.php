...
<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<?php
					$cek = mysqli_query($koneksi,"select status from tb_pengaturan where pengaturan='pendaftaran'");
					...
					$cek2 = mysqli_query($koneksi,"select status from tb_pengaturan where pengaturan='penilaian'");
					...
					$cek3 = mysqli_query($koneksi,"select status from tb_pengaturan where pengaturan='pengumuman'");
